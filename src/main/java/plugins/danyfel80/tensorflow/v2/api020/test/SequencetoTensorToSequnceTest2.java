 ...
 */
public class SequencetoTensorToSequnceTest2 extends EzPlug
{
    ...
    protected void execute()
    {
        ...
        try (Tensor<? extends TType> tensor = TensorBuilder.build(image, tensorDimOrder))
        {
            tTensor = System.currentTimeMillis();
            try (ConcreteFunction div = ConcreteFunction.create(SequencetoTensorToSequnceTest2::div);
    ...
    {
        Icy.main(args);
        PluginLauncher.start(PluginLoader.getPlugin(SequencetoTensorToSequnceTest2.class.getName()));
    }
}
